...
async function main() {
    ...
    const enderTreasuryInstance = await ethers.getContractAt(
        "EnderTreasury",
        EnderTreasury.goerli.proxy,
    );
    ...
    const enderStakingInstance = await ethers.getContractAt(
        "EnderStaking",
        "0x5215dfa5ec17192b488053c1c1e76407ac566428",
    );
