...
export interface MockStEth extends BaseContract {
  ...
  mintShare: TypedContractMethod<[share: BigNumberish], [void], "nonpayable">;

  mockWeth: TypedContractMethod<[], [string], "view">;
  ...
  ): TypedContractMethod<[share: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "mockWeth"
