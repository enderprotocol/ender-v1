...
export interface EnderPreLaunchDepositInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "bondableTokens"
...
export interface EnderPreLaunchDeposit extends BaseContract {
  connect(runner?: ContractRunner | null): EnderPreLaunchDeposit;
  waitForDeployment(): Promise<this>;

  interface: EnderPreLaunchDepositInterface;
